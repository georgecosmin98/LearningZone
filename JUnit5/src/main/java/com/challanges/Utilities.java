...
public class Utilities {
    ...
    //    Remove pairs of the same characters that are next
    //    to each other, by removing on e occurrenced of the character
    //    "ABBCDEEF" => "ABCDEF"
    ...
    //     perform a conversion based on some interval
    //     bussiness rule.
